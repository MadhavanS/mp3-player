...
class _PlayerAudioHandler extends BaseAudioHandler
  ...
  void _broadcastState() {
    // Fixed ← play/pause → strip (compact + expanded MediaStyle): matches a
    // typical mini-player. Skip taps no-op when queue has only one clip; users
    // dismiss via swipe / pause foreground policy instead of an explicit Stop.
